...
import com.example.digitracksdk.databinding.FragmentNewReimbursementPendingBinding
...
class NewReimbursementApprovedFragment : BaseFragment(),
    ...
    companion object {
        fun newInstance(): NewReimbursementApprovedFragment {
            return NewReimbursementApprovedFragment()
        }
    }
...
//        callReimbursementListApi()
    ...
    fun callReimbursementListApi() {
        binding.apply {
            if (requireActivity().isNetworkAvailable()) {
                ...
                reimbursementViewModel.callGetNewReimbursementApprovedListApi(
    ...
    private fun setUpObserver() {
        binding.apply {
            with(reimbursementViewModel) {
                newReimbursementApprovedListResponseData.observe(viewLifecycleOwner) {
                    toggleLoader(false)
                    val reimbursementApprovedList: ArrayList<ReimbursementVoucherListModel> =
                        ArrayList()
                    ...
                    if (it.ReimbursementVoucherListDetails?.isNotEmpty() == true){
                        ...
                        list.clear()
                        if (reimbursementApprovedList.isNotEmpty()) {
                            showNoDataLayout(false)
                            for (i in reimbursementApprovedList) {
                                val reimbursementType = com.example.digitracksdk.presentation.home.reimbursements.model.ReimbursementType.APPROVED
                                list.add(
                                    ReimbursementModel(
    ...
    private fun setUpAdapter() {
        binding.apply {
            adapter =
                ReimbursementAdapter(requireActivity(), list, this@NewReimbursementApprovedFragment)
