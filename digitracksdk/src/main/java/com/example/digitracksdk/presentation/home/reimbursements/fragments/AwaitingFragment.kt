...
import com.example.digitracksdk.databinding.FragmentAwaitingBinding
...
class AwaitingFragment : BaseFragment(), ReimbursementAdapter.ReimbursementClickManager {
    ...
    companion object {
        fun newInstance(): AwaitingFragment {
    ...
    private fun setUpAdapter() {
        ...
        binding.recyclerAwaitingReimbursement.adapter = adapter
    }
