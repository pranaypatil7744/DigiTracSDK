...
class ReimbursementListUseCase constructor(private val reimbursementRepository: ReimbursementRepository) :
    UseCase<ReimbursementListResponseModel, Any?>() {
    override suspend fun run(params: Any?): ReimbursementListResponseModel {
        return reimbursementRepository.callReimbursementListApi(params as ReimbursementListRequestModel)
    }
}