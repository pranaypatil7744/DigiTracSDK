...
class InsertAttendanceRegularizationUseCase constructor(private val attendanceRegularizationRepository: AttendanceRegularizationRepository) :
    ...
    override suspend fun run(params: Any?): InsertAttendanceRegularizationResponseModel {
        return attendanceRegularizationRepository.callInsertAttendanceRegularizationApi(params as InsertAttendanceRegularizationRequestModel)
    }
}