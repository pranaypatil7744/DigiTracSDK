...
class EsicMedicalCardUseCase constructor(private var pfEsicInsuranceRepository: PfEsicInsuranceRepository) :
    UseCase<PfEsicResponseModel, Any>() {
    override suspend fun run(params: Any?): PfEsicResponseModel {
        return pfEsicInsuranceRepository.callEsicMedicalCardApi(params as PfEsicRequestModel)
    }
}