...
class EsicCardUseCase constructor(private val pfEsicInsuranceRepository: PfEsicInsuranceRepository) :
    UseCase<PfEsicResponseModel, Any?>() {
    override suspend fun run(params: Any?): PfEsicResponseModel {
        return pfEsicInsuranceRepository.callEsicCardApi(params as PfEsicRequestModel)
    }
}