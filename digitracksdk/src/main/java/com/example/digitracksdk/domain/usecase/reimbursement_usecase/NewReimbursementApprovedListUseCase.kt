...
class NewReimbursementApprovedListUseCase constructor(private val reimbursementRepository: ReimbursementRepository):
    UseCase<ReimbursementListResponseModel, Any?>() {
    override suspend fun run(params: Any?): ReimbursementListResponseModel {
        return reimbursementRepository.callGetNewReimbursementApprovedListApi(params as ReimbursementListRequestModel)
    }
}